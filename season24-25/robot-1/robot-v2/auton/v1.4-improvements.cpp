...
void autonomous(void) {
    ...
    Drivetrain.setHeading(32.26, degrees);
    ...
    driveFor(26);
    wait(500, msec);
    turnTo(0, 2500, 30);     // Turn slower for accuracy
    driveFor(32, 5000, 30);  // Drive slower to allow intaking
    wait(750, msec);
