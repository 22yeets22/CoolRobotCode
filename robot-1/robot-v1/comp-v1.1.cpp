...
bool drivetrainLNeedsToBeStoppedController = true;
bool drivetrainRNeedsToBeStoppedController = true;
// Piston
...
void controlDrivetrain() {
    ...
    handleMotorControl(leftDriveSmart, drivetrainLeftSideSpeed, drivetrainLNeedsToBeStoppedController);
    handleMotorControl(rightDriveSmart, drivetrainRightSideSpeed, drivetrainRNeedsToBeStoppedController);
}
